//
//  LGHorizontalLeftFlowLayout.swift
//  Samscloud
//
...
public class LGHorizontalLeftFlowLayout: UICollectionViewFlowLayout {
    
    private var lastCollectionViewSize: CGSize = .zero
    
    public var scalingOffset: CGFloat = 100 //for offsets >= scalingOffset scale factor is minimumScaleFactor
    public var minimumScaleFactor: CGFloat = 0.83
    public var scaleItems: Bool = true
    
    
    // MARK: - ACTIONS
    
    static func configureLayout(collectionView: UICollectionView, itemSize: CGSize, minimumLineSpacing: CGFloat) -> LGHorizontalLeftFlowLayout {
        let layout = LGHorizontalLeftFlowLayout()
    ...
    public override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        for (_, attributes) in superAttributes!.enumerated() {
            ...
            newAttributes.transform3D = CATransform3DScale(CATransform3DIdentity, 1, scale, scale)
        }
