...
open class NotificationFactory: UIView,UITextViewDelegate {
    ...
    open fileprivate(set) lazy var indicatorView: UIView = {
        ...
        let view = UIView()
        view.backgroundColor            = #colorLiteral(red: 0.218211621, green: 0.4603428245, blue: 0.7887200117, alpha: 1) //InAppNotify.theme.dragIndicatorColor
    ...
    open fileprivate(set) lazy var imageView: UIImageView = {
        ...
        imageView.image = UIImage.init(named: "sams_logo")
        return imageView
    ...
    open fileprivate(set) lazy var titleLabel: UILabel = {
        ...
        let label           = UILabel()
        label.font          = UIFont.init(name: "CircularStd-Medium", size: 16) //InAppNotify.theme.titleFont
        label.textColor     = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)//InAppNotify.theme.titleColor
    ...
    open fileprivate(set) lazy var subtitleLabel: UILabel = {
        ...
        let label           = UILabel()
        label.font          = UIFont.init(name: "CircularStd-Book", size: 13) //InAppNotify.theme.subtitleFont
        label.textColor     = #colorLiteral(red: 0.4280895591, green: 0.4281002283, blue: 0.4280944169, alpha: 1)//InAppNotify.theme.subtitleColor
        label.numberOfLines = 1
        return label
    ...
    private func createViews(){
        ...
        [imageView, titleLabel].forEach { backgroundView.addSubview($0) }
    }
    ...
    open func build(forAnnouncement announcement: Announcement, to: UIViewController) {
        ...
        NotificationSize.height = UIApplication.shared.isStatusBarHidden ? 80*widthFactor : 80*widthFactor
    ...
    open func setupFramesAndPositionViews(currentWidth:CGFloat,currentHeight:CGFloat) {
        ...
        let offset: CGFloat = UIApplication.shared.isStatusBarHidden ? 16 : 16
        ...
        titleLabel.frame.origin         = CGPoint(x: NotificationSize.textOffset, y: imageView.frame.origin.y + 30)
