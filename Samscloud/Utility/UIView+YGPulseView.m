...
- (void)startPulseWithColor:(UIColor *)color animation:(YGPulseViewAnimationType)animationType {
    ...
    CGFloat startScale = animationType == YGPulseViewAnimationTypeRadarPulsing ? 1.0f : 1.5f;
    [self startPulseWithColor:color scaleFrom:startScale to:2.5f frequency:frequency opacity:0.9f animation:animationType];
}
